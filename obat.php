...
//query data mhs
$dokterData = query("SELECT * FROM obat");
...
<head>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="container p-5 m-5">
        ...
        <a href="addObat.php" class="btn btn-primary mt-5">Tambah</a>
        ...
        foreach ($dokterData as $m) : ?>
            <tr>
                ...
                <td><?= $m['harga']?></td>
                <td>
                    <a href="hapusObat.php?id=<?= $m['id'] ?>">Hapus |</a>
                    <a href="editObat.php?id=<?= $m['id'] ?>"> Edit</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
